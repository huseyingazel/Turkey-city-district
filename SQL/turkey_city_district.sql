...
-- Üretim Zamanı: 12 Kas 2023, 22:03:56
...
--
-- Veritabanı: `turkey_city_district`
--
...
CREATE TABLE `district` (
  ...
  `dis_title` varchar(255) COLLATE utf8_turkish_ci NOT NULL,
  `dis_key` int(11) NOT NULL,
  `dis_citykey` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
INSERT INTO `district` (`ilce_id`, `dis_title`, `dis_key`, `dis_citykey`) VALUES
(1, 'ADALAR', 1103, 34),
...
--
-- Tablo döküm verisi `example`
--

INSERT INTO `example` (`id`, `name`, `city`, `district`) VALUES
(1, 'Ankara - Elmadağ', 6, 1302);
...
--
-- Tablo için AUTO_INCREMENT değeri `example`
--
ALTER TABLE `example`
